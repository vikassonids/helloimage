pipeline {
    ...
    stages {
        ...
        stage('Deploy') {
            steps {
                bat 'docker service update --image vikasdsdocker/myfirstpipeline:%BUILD_NUMBER% myfirstpipelineservice || docker service create --name myfirstpipelineservice -p 81:80 --replicas 2  vikasdsdocker/myfirstpipeline:%BUILD_NUMBER%'
